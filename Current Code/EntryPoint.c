...
#pragma config(Sensor, dgtl6,  clawUltrasonic, sensorSONAR_inch)
...
task control() {
	...
	//Math variables
	int mReqLF, mReqRF, mReqLB, mReqRB, clawValue, clawClosed, rotationConstant = 0.5;
	while(true){
		...
		rotationVector = vexRT[Ch1Xmtr2] * rotationConstant;
